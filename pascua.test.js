...
test("throws error for year below 1583", () => {
  assert.throws(() => pascua(1582), /The year should be between 1583 and 4099/);
});

test("throws error for year above 4099", () => {
  assert.throws(() => pascua(4100), /The year should be between 1583 and 4099/);
});
